...
class TestFiles:
    ...
    @allure.tag(AllureTag.VALIDATE_ENTITY)  # Добавили тег
    @allure.story(AllureStory.VALIDATE_ENTITY)  # Добавили тег
    ...
    def test_get_file_with_incorrect_file_id(self, files_client: FilesClient):
        ...
        incorrect_response = files_client.get_file_api("incorrect-file-id")
        incorrect_response_data = ValidationErrorResponseSchema.model_validate_json(incorrect_response.text)

        assert_status_code(incorrect_response.status_code, HTTPStatus.UNPROCESSABLE_ENTITY)
        assert_get_file_with_incorrect_file_id_response(incorrect_response_data)
        validate_json_schema(incorrect_response.json(), incorrect_response_data.model_json_schema())
